...
- Exit: will load the Lobby page.
    ...
    <img src="Assets/Sprites/GreenFood.png" alt="Alt Text" width="100" height="120"> <div style="margin-right: 20px;"> <img src="Assets/Sprites/RedFood.png" alt="Alt Text" width="100" height="120">

    <div style="display: flex; justify-content: flex-start;">
    <img src="Assets/Sprites/GreenFood.png" alt="Alt Text" width="100" height="120" style="margin-right: 2000px;"> <img src="Assets/Sprites/RedFood.png" alt="Alt Text" width="100" height="120">
</div>
